...
int main(int argc, char* argv[])
{
    ...
    cout << "value: " << map_it->second << endl;; // print the value for this element
    cout << "key: Anna\nValue:" << word_count["Anna"] << endl; // fetch element indexed by Anna; 
    ...
    */
    ...
    map<string, int>::const_iterator
        map_iterator = word_count.begin();

    // for each element in the map
    while(map_iterator != word_count.end())
    {
        // print the element key, value pairs
        cout << map_iterator->first << " occurs "
            << map_iterator->second << " times" << endl;
        ++map_iterator;
    }
